  ...
  <BaseDialog :show="show" :title="dialogTitle" width="narrow" @close="handleClose">
    ...
    <div v-if="!success" class="flex flex-col items-center space-y-4">
      ...
      <template v-if="qrUrl">
        ...
        <p v-if="scanHint" class="text-center text-sm text-slate-500 dark:text-slate-400">
          {{ scanHint }}
        </p>
      </template>
      ...
      <template v-else>
        <div class="flex flex-col items-center py-4">
          ...
          <p class="mt-4 text-sm text-slate-500 dark:text-slate-400">{{ t('payment.qr.payInNewWindowHint') }}</p>
      ...
      <div v-else class="text-center">
        <p class="text-sm text-slate-500 dark:text-slate-400">{{ qrUrl ? t('payment.qr.expiresIn') : '' }}</p>
    ...
    <div v-else class="flex flex-col items-center space-y-4 py-4">
      ...
      <p class="text-lg font-bold text-slate-900 dark:text-white">{{ t('payment.result.success') }}</p>
