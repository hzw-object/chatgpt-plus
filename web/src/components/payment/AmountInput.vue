    ...
    <div>
      ...
      <div class="grid grid-cols-3 gap-2">
        <button
          ...
          type="button"
          :class="[
            'rounded-xl border-2 px-4 py-3 text-center font-medium transition-colors',
            modelValue === amt
              ? 'border-slate-500 bg-slate-50 text-violet-700 dark:border-violet-400 dark:bg-slate-900/40 dark:text-slate-300'
