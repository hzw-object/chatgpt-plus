<template>
  <div class="inline-flex flex-col gap-0.5 text-xs font-medium">
    ...
    <div v-if="planLabel || privacyBadge" class="inline-flex items-center overflow-hidden rounded-lg">
    ...
    <div v-if="expiresLabel" class="text-[10px] leading-tight text-slate-400 dark:text-slate-500 pl-0.5" :title="subscriptionExpiresAt">
      {{ expiresLabel }}
    </div>
  </div>
</template>
