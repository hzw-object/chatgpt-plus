    ...
    >
      ...
      >
        <div
          ...
          :key="toast.id"
          :class="[
            'pointer-events-auto min-w-[320px] max-w-md overflow-hidden rounded-xl shadow-lg',
        ...
        >
          <div class="p-4">
            <div class="flex items-start gap-3">
              ...
              <button
                ...
                class="-m-1 flex-shrink-0 rounded p-1 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-600 dark:text-slate-500 dark:hover:bg-slate-700 dark:hover:text-slate-300"
          ...
          <!-- Progress bar -->
          <div v-if="toast.duration" class="h-1 bg-slate-100 dark:bg-slate-700">
            <div
