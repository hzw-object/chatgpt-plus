      ...
      <div v-if="isOpen" class="date-picker-dropdown">
        ...
        <div class="date-picker-custom">
          ...
          <div class="date-picker-separator">
            <Icon name="arrowRight" size="sm" class="text-slate-400" />
          </div>
          <div class="date-picker-field">
...
.date-picker-preset-active {
  @apply bg-slate-100 dark:bg-slate-900/30;
...
.date-picker-label {
  @apply mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400;
}
...
.date-picker-apply {
  @apply rounded-xl px-4 py-1.5 text-sm font-medium;
