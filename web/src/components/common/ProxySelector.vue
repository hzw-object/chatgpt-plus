      ...
      <div v-if="isOpen" class="select-dropdown">
        ...
        <div class="select-options">
          ...
          >
            ...
            <Icon v-if="modelValue === null" name="check" size="sm" class="text-slate-500" />
          </div>
            ...
            <div class="min-w-0 flex-1">
              <div class="flex items-center gap-2">
                ...
                <span
                  ...
                  class="inline-flex flex-shrink-0 items-center rounded bg-slate-100 px-1.5 py-0.5 text-xs text-slate-600 dark:bg-slate-600 dark:text-slate-400"
                >
                  {{ proxy.account_count }}
                </span>
                <!-- Test result badges -->
...
.select-trigger {
  ...
  @apply focus:border-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-500/30;
  @apply hover:border-slate-300 dark:hover:border-slate-500;
  @apply cursor-pointer;
}

.select-trigger-open {
  @apply border-slate-500 ring-2 ring-slate-500/30;
}

.select-trigger-disabled {
  @apply cursor-not-allowed bg-slate-100 opacity-60 dark:bg-slate-900;
}
...
.select-icon {
  @apply flex-shrink-0 text-slate-400 dark:text-slate-400;
}
...
.batch-test-btn {
  @apply flex-shrink-0 rounded-xl p-1.5;
  @apply text-slate-500 hover:text-emerald-600 dark:hover:text-emerald-400;
...
.select-option-selected {
  @apply bg-slate-50 dark:bg-slate-900/20;
  @apply text-violet-700 dark:text-slate-300;
}
...
.test-btn {
  ...
  @apply text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400;
  @apply hover:bg-emerald-50 dark:hover:bg-emerald-900/20;
  @apply transition-colors disabled:cursor-not-allowed disabled:opacity-50;
}
